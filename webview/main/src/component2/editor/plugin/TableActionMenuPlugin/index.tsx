...
import { MenuContextComponent } from './component/component';
...
function TableActionMenu({
  ...
  return createPortal(
    ...
    >
      <NgOutletReact
        component={MenuContextComponent}
        props={{
          insertTableRowAtSelection,
          insertTableColumnAtSelection,
          deleteTableColumnAtSelection,
          ...
          canMergeCells,
          getTextContent: () =>
            editor.read(() => tableCellNode.getTextContent()),
        }}
      ></NgOutletReact>
    ...
    <div className="table-cell-action-button-container" ref={menuButtonRef}>
      {tableCellNode != null && (
        <>
          <button
            type="button"
            className="table-cell-action-button  material-icons !flex"
            onClick={(e) => {
              e.stopPropagation();
