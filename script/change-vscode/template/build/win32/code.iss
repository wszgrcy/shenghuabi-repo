...
AppPublisher=Chen
AppPublisherURL=https://www.shenghuabi.top/
AppSupportURL=https://www.shenghuabi.top/
AppUpdatesURL=https://www.shenghuabi.top/
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=shenghuabi-win32-x64-{#Version}.setup
Compression=lzma
...
Name: "addcontextmenufolders"; Description: "{cm:AddContextMenuFolders,{#NameShort}}"; GroupDescription: "{cm:Other}"; Check: not (IsWindows11OrLater and QualityIsInsiders)
